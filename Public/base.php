...
<head>
  ...
  <link rel="icon" href="Public/assets/images/rw2.png">
</head>
  ...
  <header>
    <div class="profile-page sidebar-collapse">
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
        <div class="container">
          <div class="navbar-translate"><a class="navbar-brand" href="/" rel="tooltip">Mon CV</a>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <ul class="navbar-nav">
              ...
              <!-- <li class="nav-item"><a class="nav-link smooth-scroll" href="https://portfolio.wiremi.fr">Portfolio</a></li> -->
